...
# game image
background_image = pygame.image.load("flapsterbg.png")
bird_image = pygame.image.load("flapsterbird.png")
...
def draw():
    ...
    if game_over:
        ...
        draw_text_with_shadow(
            window, "Game Over", text_font, "white", (50, 50, 50), 30, 220
        )

        score_text = f"Score:  {int(score)}"
        draw_text_with_shadow(
            window, score_text, small_font, "white", (50, 50, 50), 30, 285
        )

        best_color = (255, 215, 0) if int(score) >= best_score else "white"
        best_text = f"Best:    {best_score}"
        draw_text_with_shadow(
            window, best_text, small_font, best_color, (50, 50, 50), 30, 313
        )
        ...
        # Live score (top-left)
        draw_text_with_shadow(
            window, str(int(score)), text_font, "white", (50, 50, 50), 5, 0
        )
